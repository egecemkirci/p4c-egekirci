...
struct Algorithm_Model : public ::Model::Enum_Model {
    Algorithm_Model() : ::Model::Enum_Model("HashAlgorithm"),
                        ...
                        random("random"), identity("identity"), csum16("csum16"), xor16("xor16"), my_md5_64("my_md5_64"), my_sha256("my_sha256"), my_murmur32("my_murmur32") {}
    ::Model::Elem crc32;
    ...
    ::Model::Elem csum16;
    ::Model::Elem xor16;
    ::Model::Elem my_md5_64;
    ::Model::Elem my_sha256;
    ::Model::Elem my_murmur32;
};
